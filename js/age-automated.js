...
function updateText() {
  ...
  const newText = `Hallöchen! Ich bin ein  ${years} Jahre alter Junior Software Developer, der Spaß an der Entwicklung hat! Unten findet Ihr meine derzeitigen Erfolge:`;
